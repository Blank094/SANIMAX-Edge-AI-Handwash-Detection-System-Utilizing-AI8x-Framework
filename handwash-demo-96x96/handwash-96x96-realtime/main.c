...
#define IMAGE_SIZE_X (96)
#define IMAGE_SIZE_Y (96)
...
// static uint32_t display_result_counter = 0; // Counter for displaying results
...
{
    // display_result_counter++; // Increment the counter
    int i, digs, tens_val;
    int max_index = 0;
